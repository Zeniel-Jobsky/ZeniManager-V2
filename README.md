...
![캘린더 및 상담 예약](./docs/ppt/counselor-calendar.png)

- 월간 캘린더에서 날짜별 상담 예약 현황과 예정 상담 수를 한눈에 확인할 수 있습니다.
- 오늘, 7일, 기간 선택 필터를 통해 특정 기간의 상담 일정을 빠르게 조회합니다.
- 신규 예약 등록과 일정 변경, 상담기록 저장 및 완료 처리까지 상담 일정 관리 흐름을 한 화면에서 수행할 수 있습니다.
